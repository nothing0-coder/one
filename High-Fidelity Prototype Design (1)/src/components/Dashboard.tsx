    ...
    ? [
        {
          ...
          icon: DollarSign,
          color:
            parseFloat(stats.totalBalance) >= 0
              ? "text-green-600"
              : "text-red-600",
        },
        {
            ...
            <Card className="relative overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`w-10 h-10 rounded-lg bg-gradient-to-br from-${stat.color.split("-")[1]}-100 to-${stat.color.split("-")[1]}-200 flex items-center justify-center`}
                  >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <Progress
                  value={Math.min((stats?.totalExpenses || 0) * 10, 100)}
                  className="h-2"
                />
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    ${stats?.totalAmountTracked || "0.00"}
                  </span>
                </div>
                <Progress
                  value={Math.min(
                    parseFloat(stats?.totalAmountTracked || "0") / 10,
                    100,
                  )}
                  className="h-2"
                />
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">
                  $
                  {recentExpenses.length > 0
                    ? Math.max(...recentExpenses.map((e) => e.amount)).toFixed(
                        2,
                      )
                    : "0.00"}
                </span>
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`font-medium ${parseFloat(stats?.totalBalance || "0") >= 0 ? "text-green-600" : "text-red-600"}`}
                >
