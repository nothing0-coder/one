...
export default function Groups() {
  ...
  const handleAddMember = async () => {
    ...
    try {
      const result = await api.addGroupMember(
        accessToken!,
        selectedGroupId,
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new group to start splitting expenses with friends and
                family.
              </DialogDescription>
            </DialogHeader>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <div
                          className={`w-10 h-10 rounded-lg ${group.color || "bg-gradient-to-br from-blue-500 to-purple-600"} flex items-center justify-center`}
                        >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-muted-foreground">
                        Members (
                        {group.members?.length || group.memberCount || 1})
                      </span>
                      <Button
                        variant="ghost"
                        size="sm"
                    ...
                    <div className="flex items-center gap-4 text-xs text-muted-foreground">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {group.recentActivity
                          ? formatDate(group.recentActivity)
                          : "New group"}
                      </div>
                    </div>
      ...
      {/* Quick Actions */}
      <motion.div className="grid md:grid-cols-3 gap-4" {...fadeInUp}>
